                    ...
                    rounded-lg group overflow-hidden">
                        <div className="w-full h-[260px] relative">
                            <Link href={`/product/${id}`}>
                                ...
                                transition-transform duration-300" width={300} height={300} style={{height: "auto"}} src={image} alt="productImg"/>
                            </Link>
                        ...
                        <div className="px-4 py-3 flex flex-col gap-1">
                            ...
                            <Link href={`/product/${id}`}>
                                <h2 className="text-base font-medium hover:text-amazon_blue cursor-pointer">{title}</h2>
                            </Link>
                        ...
                        )} className="h-10 font-medium bg-amazon_blue text-white rounded-md hover:bg-amazon_yellow 
